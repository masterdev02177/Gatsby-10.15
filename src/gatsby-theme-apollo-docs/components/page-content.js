...
import * as SpectrumLogo from '-!@svgr/webpack!../assets/spectrum.svg';
...
function FeedbackLink(props) {
	...
	return (
		<AsideLinkWrapper>
			<AsideLinkInner onClick={handleClick}>{/* <IconStar style={{marginTop: -2}} /> Rate article */}</AsideLinkInner>
		</AsideLinkWrapper>
	);
}
	...
	return (
		<Wrapper>
			...
			<Aside>
				...
				{
					props.headings.length > 0 && <SectionNav headings={props.headings} contentRef={contentRef} imagesLoaded={imagesLoaded === imagesToLoad} />}
				{
