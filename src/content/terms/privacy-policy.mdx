...
Some Personal Data is automatically collected when you use our software or vist our website such as the following:
...
Our products may use third party analytic tools that use cookies, web beacons, or other similar information gathering technologies to collect standard log information and product usage information. The information generated is used to compile statistical reports on product useage and use activity. 
